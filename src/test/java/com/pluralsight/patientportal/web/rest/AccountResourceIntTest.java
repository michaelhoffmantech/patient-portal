...
import com.pluralsight.patientportal.domain.PersistentToken;
import com.pluralsight.patientportal.domain.User;
import com.pluralsight.patientportal.repository.AuthorityRepository;
import com.pluralsight.patientportal.repository.PersistentTokenRepository;
...
import com.pluralsight.patientportal.web.rest.vm.KeyAndPasswordVM;
...
public class AccountResourceIntTest {
    ...
    public void testRegisterValid() throws Exception {
        ManagedUserVM validUser = new ManagedUserVM(
            ...
            new HashSet<>(Collections.singletonList(AuthoritiesConstants.PATIENT)));
